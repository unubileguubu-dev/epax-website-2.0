...
(function () {
  ...
  var MN = {
    ...
    /* ---- FAQ page ---- */
    'Frequently asked questions': 'Түгээмэл асуулт, хариулт',
    'Everything hotel, restaurant, and tour operators ask us before starting — answered plainly.': 'Зочид буудал, ресторан, тур операторуудын эхлэхээсээ өмнө асуудаг бүх зүйл — энгийнээр хариулав.',
    'What exactly does EPAX do?': 'EPAX яг юу хийдэг вэ?',
    'We are a digital back office for Mongolian hospitality businesses. We set up and maintain your presence on Google Maps, TripAdvisor, and Booking.com, publish weekly English social media, answer every guest inquiry and review in fluent English, and send you a clear monthly report — plus e-invoice processing on the Full Ops plan.': 'Бид Монголын зочлох үйлчилгээний бизнесүүдийн дижитал ар алба. Google Maps, TripAdvisor, Booking.com дээрх байр суурийг тань бүрдүүлж, долоо хоног бүр англи сошиал контент нийтэлж, зочны лавлагаа, сэтгэгдэл бүрд чөлөөтэй англи хэлээр хариулж, ойлгомжтой сарын тайлан хүргэнэ — Бүрэн үйл ажиллагаа багцад и-баримт боловсруулалт нэмэгдэнэ.',
    'How much does it cost?': 'Ямар үнэтэй вэ?',
    'Starter is $200/month, Growth is $400/month, and Full Ops is $600/month. Restaurants start at $150/month and touring companies at $300/month. Every plan is month-to-month with no lock-in.': 'Стартер сард 730,000₮, Өсөлт сард 1,460,000₮, Бүрэн үйл ажиллагаа сард 2,190,000₮. Ресторан сард 547,500₮-аас, тур компани сард 1,095,000₮-аас эхэлнэ. Бүх багц сар бүрийн сунгалттай, урт гэрээгүй.',
    'What is the free audit?': 'Үнэгүй аудит гэж юу вэ?',
    'A report, ready within 24 hours, showing exactly what foreign tourists see when they search for your business — in English and Mongolian, with no commitment. It is the first step for every client.': 'Гадаад жуулчид таны бизнесийг хайхад яг юу хардагийг харуулсан тайлан — 24 цагийн дотор, англи монгол хэлээр, ямар ч амлалтгүй. Энэ бол харилцагч бүрийн эхний алхам.',
    'What does the EPAX guarantee mean?': 'EPAX баталгаа гэж юу гэсэн үг вэ?',
    'If month one fails to deliver, month two is free. Simple as that.': 'Эхний сар үр дүн өгөхгүй бол дараагийн сар үнэгүй. Ердөө л ийм.',
    'Do I need to sign a long contract?': 'Урт хугацааны гэрээ байгуулах шаардлагатай юу?',
    'No. Every plan renews month-to-month and you can stop any time. Touring companies can also pause entirely in the off-season and pay only for the months they operate.': 'Үгүй. Бүх багц сар бүр сунгагддаг бөгөөд хүссэн үедээ зогсоож болно. Тур компаниуд улирлын завсарлага авч, зөвхөн ажилладаг саруудаа төлж болно.',
    'Who owns the accounts and the content?': 'Хаяг, контентыг хэн эзэмших вэ?',
    'You do. Google Maps, TripAdvisor, Booking.com, Instagram, Facebook — every profile stays registered to your business, and everything we create for you remains yours if you leave.': 'Та өөрөө. Google Maps, TripAdvisor, Booking.com, Instagram, Facebook — бүх профайл таны бизнесийн нэр дээр бүртгэлтэй хэвээр байх бөгөөд бидний бүтээсэн бүхэн та гарсан ч таных хэвээр үлдэнэ.',
    'How fast do you answer guest inquiries?': 'Зочны лавлагаанд хэр хурдан хариулдаг вэ?',
    'Our working target is a reply within two business hours, in fluent English — every DM, review, and booking question.': 'Бидний ажлын зорилт — ажлын хоёр цагийн дотор, чөлөөтэй англи хэлээр хариулах. Мессеж, сэтгэгдэл, захиалгын асуулт бүрд.',
    'Is the content written by AI?': 'Контентыг AI бичдэг үү?',
    'AI drafts and classifies in seconds, but a bilingual editor approves every word before it reaches a guest. Fully AI-generated content does not win bookings — travelers can tell.': 'AI хэдхэн секундэд ноорог бэлдэж, ангилдаг ч зочинд хүрэх үг бүрийг хоёр хэлтэй редактор баталдаг. Бүхэлдээ AI-р бичсэн контент захиалга авчирдаггүй — аялагчид мэдэрдэг.',
    'How do we communicate with you?': 'Бид тантай хэрхэн харилцах вэ?',
    'In Mongolian or English, whichever you prefer — by phone, Instagram, or email. Your monthly report comes in clear Mongolian.': 'Монгол эсвэл англи хэлээр — таны сонголтоор. Утас, Instagram, имэйлээр. Сарын тайлан тань ойлгомжтой монгол хэлээр ирнэ.',
    'How many clients do you take?': 'Хэдэн харилцагч авдаг вэ?',
    'Five new clients per quarter, so quality never slips. If the quarter is full, the audit still holds your place in line.': 'Улирал бүр таван шинэ харилцагч — чанараа алдахгүйн тулд. Улирал дүүрсэн бол аудит таны дараалалд байр эзэлнэ.',
    'Still deciding? Start with the audit — it is free.': 'Эргэлзсэн хэвээр үү? Аудитаас эхлээрэй — үнэгүй шүү дээ.',
    'Get my free audit': 'Үнэгүй аудитаа авах',
    'FAQ': 'Асуулт',
    ...
    "Effective 1 July 2026. Written in plain language on purpose — if anything is unclear, ask us before signing up.": "2026 оны 7 дугаар сарын 1-нээс хүчинтэй. Зориуд энгийн хэлээр бичив — ойлгомжгүй зүйл байвал бүртгүүлэхээсээ өмнө биднээс асуугаарай.",
    "1. Who we are": "1. Бид хэн бэ",
    "EPAX is a digital back-office service operated from Ulaanbaatar, Mongolia, for hospitality businesses: we manage platform presence, English social media, guest communications, and reporting on behalf of our clients. These terms apply to every EPAX service plan.": "EPAX бол Улаанбаатараас ажилладаг, зочлох үйлчилгээний бизнесүүдэд зориулсан дижитал ар албаны үйлчилгээ: бид харилцагчдынхаа өмнөөс платформ дээрх байр суурь, англи хэлт сошиал медиа, зочидтой харилцах, тайлагналыг хариуцдаг. Эдгээр нөхцөл EPAX-ийн бүх багцад үйлчилнэ.",
    "2. Plans and what they include": "2. Багцууд ба тэдгээрт юу багтдаг",
    "Each plan's scope is described on our pricing page at the time you subscribe. The free audit is exactly that — free, with no obligation. We accept a maximum of five new clients per quarter, in the order requests arrive.": "Багц бүрийн хамрах хүрээ таныг бүртгүүлэх үеийн үнийн хуудсанд тодорхойлогдоно. Үнэгүй аудит нэрнийхээ дагуу үнэгүй, ямар ч үүрэг үүсгэхгүй. Бид улирал бүр дээд тал нь таван шинэ харилцагчийг хүсэлтийн дарааллаар авна.",
    "3. Billing": "3. Төлбөр",
    "Plans are billed monthly, in advance. Prices are quoted in US dollars with tugrik equivalents shown for convenience; we invoice in the currency agreed at signup and provide compliant e-invoices. A month of service begins on the date of payment.": "Багцын төлбөр сар бүр урьдчилж төлөгдөнө. Үнийг ам.доллараар, төгрөгийн дүйцүүлэлтийн хамт харуулдаг; гэрээ байгуулахад тохирсон валютаар нэхэмжилж, и-баримт олгоно. Үйлчилгээний сар төлбөр хийсэн өдрөөс эхэлнэ.",
    "4. The EPAX guarantee": "4. EPAX баталгаа",
    "If the first paid month fails to deliver the work promised in your plan, the second month is free. The guarantee applies once per client, to the first month only, and requires that we had the access described in section 6.": "Төлбөртэй эхний сар багцад амласан ажлыг гүйцэтгэж чадаагүй бол дараагийн сар үнэгүй. Баталгаа нэг харилцагчид нэг удаа, зөвхөн эхний сард үйлчлэх бөгөөд 6 дугаар зүйлд заасан хандалтыг бидэнд өгсөн байхыг шаардана.",
    "5. Cancellation": "5. Цуцлалт",
    "Every plan is month-to-month. You may cancel any time with effect from the end of the paid month; there are no cancellation fees and no lock-in. Touring-company plans may pause for the off-season and resume without re-onboarding.": "Бүх багц сар бүрийн сунгалттай. Та хүссэн үедээ цуцалж болох бөгөөд төлсөн сарын эцсээс хүчинтэй; цуцлалтын хураамж, урт гэрээ гэж байхгүй. Тур компанийн багцууд улирлын завсарлага авч, дахин бүртгэлгүйгээр үргэлжлүүлж болно.",
    "6. What we need from you": "6. Танаас юу шаардагдах вэ",
    "To do the work we need access to the relevant accounts (or permission to create them in your name), accurate information about your business, and a responsive contact for questions that need an owner's answer. Delays caused by missing access or information do not extend a paid month.": "Ажлыг хийхийн тулд бидэнд холбогдох хаягуудын хандалт (эсвэл таны нэр дээр үүсгэх зөвшөөрөл), бизнесийн тань үнэн зөв мэдээлэл, эзний хариулт шаардлагатай асуултад шуурхай хариулах холбоо барих хүн хэрэгтэй. Хандалт, мэдээлэл дутсанаас үүссэн саатал төлбөртэй сарыг сунгахгүй.",
    "7. Ownership": "7. Өмчлөл",
    "Every account and profile stays registered to your business, and everything we create for you — descriptions, photos edits, replies, reports — belongs to you, during the engagement and after it ends.": "Бүх хаяг, профайл таны бизнесийн нэр дээр бүртгэлтэй хэвээр байх бөгөөд бидний танд бүтээсэн бүхэн — тайлбар, засварласан зураг, хариулт, тайлан — хамтын ажиллагааны үеэр ч, дууссаны дараа ч таных.",
    "8. What we promise — and what we can't": "8. Бид юу амлаж, юуг амлаж чадахгүй вэ",
    "We promise the work: presence maintained, content published, inquiries and reviews answered, reports delivered. We cannot promise specific occupancy, revenue, or review scores — no honest agency can, and our case studies say so explicitly.": "Бид ажлыг амлана: орон зай арчлагдана, контент нийтлэгдэнэ, лавлагаа, сэтгэгдэлд хариулна, тайлан хүргэгдэнэ. Тодорхой дүүргэлт, орлого, үнэлгээ амлаж чадахгүй — шударга агентлаг үүнийг амладаггүй бөгөөд манай кейс судалгаанууд үүнийг ил хэлдэг.",
    "9. Confidentiality": "9. Нууцлал",
    "We treat your business information, credentials, and figures as confidential and use them only to deliver the service. We never share client data with third parties except the platforms your service requires.": "Бид таны бизнесийн мэдээлэл, нэвтрэх эрх, тоо баримтыг нууц гэж үзэж, зөвхөн үйлчилгээг хүргэхэд ашиглана. Харилцагчийн мэдээллийг үйлчилгээнд тань шаардлагатай платформуудаас өөр гуравдагч этгээдэд хэзээ ч дамжуулахгүй.",
    "10. Liability": "10. Хариуцлага",
    "Our total liability for any claim connected to the service is limited to the fees you paid in the three months before the claim arose. We are not liable for platform outages, policy changes, or decisions made by Google, Meta, Booking.com, TripAdvisor, or similar third parties.": "Үйлчилгээтэй холбоотой аливаа нэхэмжлэлд хүлээх бидний нийт хариуцлага нэхэмжлэл үүсэхээс өмнөх гурван сард таны төлсөн төлбөрөөр хязгаарлагдана. Google, Meta, Booking.com, TripAdvisor зэрэг гуравдагч талын доголдол, бодлогын өөрчлөлт, шийдвэрт бид хариуцлага хүлээхгүй.",
    "11. Changes and governing law": "11. Өөрчлөлт ба хууль",
    "If we change these terms we will notify active clients by email or message at least 14 days in advance. These terms are governed by the laws of Mongolia; disputes are settled in the courts of Ulaanbaatar.": "Эдгээр нөхцөлийг өөрчлөх бол идэвхтэй харилцагчдад дор хаяж 14 хоногийн өмнө имэйл эсвэл мессежээр мэдэгдэнэ. Эдгээр нөхцөл Монгол улсын хуулиар зохицуулагдаж, маргааныг Улаанбаатар хотын шүүхээр шийдвэрлэнэ.",
    "12. Contact": "12. Холбоо барих",
    "Questions about these terms: hello@epax.mn, or message @epax.ub on Instagram.": "Эдгээр нөхцөлийн талаарх асуулт: hello@epax.mn, эсвэл Instagram дээр @epax.ub хаягаар бичээрэй.",

    /* ---- privacy page ---- */
    "Privacy Policy": "Нууцлалын бодлого",
    "Effective 1 July 2026. Short version: we collect the minimum needed to run EPAX, we never sell data, and your business information stays yours.": "2026 оны 7 дугаар сарын 1-нээс хүчинтэй. Товчоор: бид EPAX-ийг ажиллуулахад шаардлагатай хамгийн бага мэдээллийг цуглуулдаг, мэдээлэл хэзээ ч зардаггүй, бизнесийн тань мэдээлэл таных хэвээр үлдэнэ.",
    "What we collect": "Бид юу цуглуулдаг вэ",
    "When you request an audit we collect what you type into the form: your name, business name, and phone number. If you contact us by email, Instagram, or phone, we keep that correspondence. As a client, we additionally hold the business information needed to deliver the service — account access, photos, prices, and calendars you share with us.": "Аудит хүсэхэд таны маягтад бичсэн зүйлийг цуглуулна: нэр, бизнесийн нэр, утасны дугаар. Имэйл, Instagram, утсаар холбогдвол тэр харилцааг хадгална. Харилцагчийн хувьд үйлчилгээг хүргэхэд шаардлагатай бизнесийн мэдээллийг нэмж хадгална — таны хуваалцсан хаягийн хандалт, зураг, үнэ, хуанли.",
    "How we use it": "Хэрхэн ашигладаг вэ",
    "Audit-request details are used for one thing: preparing your audit and contacting you about it. Client information is used only to deliver the plan you pay for. We do not run advertising lists and we do not sell or rent data to anyone.": "Аудитын хүсэлтийн мэдээллийг ганц зүйлд ашиглана: таны аудитыг бэлтгэж, энэ талаар тантай холбогдоход. Харилцагчийн мэдээллийг зөвхөн таны төлсөн багцыг хүргэхэд ашиглана. Бид сурталчилгааны жагсаалт хөтөлдөггүй, мэдээллийг хэнд ч зардаггүй, түрээслүүлдэггүй.",
    "Analytics": "Аналитик",
    "The site uses privacy-respecting page analytics (Vercel Web Analytics) to count visits and measure which pages work. It does not use advertising cookies and does not follow you across other websites. Technical error reports contain no personal information.": "Сайт зочлолтыг тоолж, аль хуудас ажиллаж байгааг хэмжихийн тулд нууцлалыг хүндэтгэсэн аналитик (Vercel Web Analytics) ашигладаг. Сурталчилгааны күүки ашигладаггүй, таныг бусад сайтаар дагадаггүй. Техникийн алдааны тайланд хувийн мэдээлэл байхгүй.",
    "Who else touches the data": "Өөр хэн мэдээлэлд хүрдэг вэ",
    "Three kinds of processors: our hosting provider (Vercel), our form-delivery service (which forwards audit requests to our inbox), and the platforms your service requires — Google, Meta, TripAdvisor, Booking.com. Each receives only what its role needs.": "Гурван төрлийн боловсруулагч: хостинг үйлчилгээ (Vercel), маягт дамжуулах үйлчилгээ (аудитын хүсэлтийг манай шуудан руу дамжуулдаг), мөн үйлчилгээнд тань шаардлагатай платформууд — Google, Meta, TripAdvisor, Booking.com. Тус бүр зөвхөн үүрэгтээ хэрэгтэйгээ л авна.",
    "Retention": "Хадгалалт",
    "Audit requests that do not become clients are deleted within 12 months. Client records are kept for the engagement plus the period Mongolian accounting law requires for invoices. Correspondence is kept as long as it is useful for serving you.": "Харилцагч болоогүй аудитын хүсэлтийг 12 сарын дотор устгана. Харилцагчийн бүртгэлийг хамтын ажиллагааны хугацаа дээр нэмээд нэхэмжлэхэд Монголын нягтлан бодох бүртгэлийн хуулийн шаардсан хугацаагаар хадгална. Харилцааг танд үйлчлэхэд хэрэгтэй байх хугацаанд хадгална.",
    "Your rights": "Таны эрх",
    "Ask us any time what we hold about you, ask for a correction, or ask for deletion of anything the law does not require us to keep. One message is enough.": "Бид таны талаар юу хадгалж байгааг хүссэн үедээ асууж, засвар хийлгэж, хуулиар хадгалахыг шаардаагүй бүхнийг устгуулж болно. Ганц мессеж хангалттай.",
    "Contact": "Холбоо барих",
    "Privacy questions: hello@epax.mn, or message @epax.ub on Instagram. EPAX operates from Ulaanbaatar, Mongolia, and this policy is governed by the laws of Mongolia.": "Нууцлалын асуулт: hello@epax.mn, эсвэл Instagram дээр @epax.ub хаягаар бичээрэй. EPAX Улаанбаатар хотоос үйл ажиллагаа явуулдаг бөгөөд энэ бодлого Монгол улсын хуулиар зохицуулагдана.",

    /* ---- blog: ger-camp-bookings ---- */
    "How ger camps stay booked all season": "Гэр баазууд хэрхэн улирлын турш захиалгатай байдаг вэ",

    /* ---- blog: ger-camp-bookings body ---- */
    "A ger camp has the strongest product in Mongolian tourism — the thing every traveler flies here to experience — and often the weakest digital presence. The camps that stay booked from the first May inquiry to the last September checkout are not always the most beautiful ones. They are the findable, answerable ones. Here is what they do differently.": "Гэр бааз бол Монголын аялал жуулчлалын хамгийн хүчтэй бүтээгдэхүүн — аялагч бүрийн үүний төлөө нисэж ирдэг зүйл — гэтэл дижитал орон зай нь ихэвчлэн хамгийн сул нь байдаг. Тавдугаар сарын эхний лавлагаанаас есдүгээр сарын сүүлчийн зочин хүртэл захиалгатай байдаг баазууд үргэлж хамгийн үзэсгэлэнтэй нь байдаггүй. Олддог, хариулдаг нь байдаг. Тэд юуг өөрөөр хийдгийг хүргэе.",
    "They can be found from a city apartment": "Тэднийг хотын байрнаас олж болдог",
    "Travelers plan the steppe months ahead, from Seoul, Berlin, and Tokyo. A camp that exists only through tour operators or a Facebook page in Mongolian is invisible to them. The booked camps have a complete English profile on Google Maps with an accurate pin, photos of the gers inside and out, and a description that answers the first three questions every traveler has: how far, how comfortable, and what do we eat.": "Аялагчид тал нутгаа хэдэн сарын өмнөөс Сөүл, Берлин, Токиогоос төлөвлөдөг. Зөвхөн тур оператороор эсвэл монгол хэлт Facebook хуудсаар л оршдог бааз тэдэнд үл үзэгдэнэ. Захиалгатай баазууд Google Maps дээр зөв зүүтэй, гэрийн гадна дотны зурагтай, аялагч бүрийн эхний гурван асуултад — хэр хол, хэр тухтай, юу иддэг вэ — хариулсан бүрэн англи профайлтай байдаг.",
    "Their directions actually work": "Ирэх заавар нь үнэхээр ажилладаг",
    "The most common one-star complaint against ger camps is not comfort — it is arrival. Guests driving themselves get lost, arrive frustrated, and review accordingly. Booked camps publish arrival instructions with photographed landmarks and keep the map pin verified. It is unglamorous work that directly protects your rating.": "Гэр баазуудад ирдэг нэг одтой гомдлын хамгийн түгээмэл нь тав тух биш — очих зам. Өөрөө жолоодож яваа зочид төөрч, бухимдаж ирээд, тэр дагуу нь сэтгэгдэл бичдэг. Захиалгатай баазууд зурагтай газарчлах тэмдэгтэй ирэх заавар нийтэлж, газрын зүүгээ баталгаажуулж байлгадаг. Энэ бол таны үнэлгээг шууд хамгаалдаг, гоц биш ажил.",
    "Someone answers, even off-grid": "Сүлжээгүй ч гэсэн хэн нэгэн хариулдаг",
    "Signal at camp is often poor, and that is fine — but the inquiry sent in February decides the booking in July. Camps that win have someone in the city answering messages within hours in English: availability, transfers, weather questions, dietary requests. Camps that lose have a message from March still sitting unread in May.": "Бааз дээр сүлжээ ихэвчлэн муу байдаг — энэ зүгээр. Гэхдээ хоёрдугаар сард илгээсэн лавлагаа долдугаар сарын захиалгыг шийддэг. Ялдаг баазуудад хотод сууж, хэдхэн цагийн дотор англиар хариулдаг хүн байдаг: сул орон тоо, трансфер, цаг агаар, хоолны хүсэлт. Ялагддаг баазуудад гуравдугаар сарын мессеж тавдугаар сард ч уншигдаагүй хэвтсээр байдаг.",
    "They plan for the shoulder months": "Тэд захын саруудаа урьдчилан төлөвлөдөг",
    "June and September are won in advance: fresh photos posted while the season runs, reviews answered the same week, and next-season inquiries collected before the camp closes. A camp that goes silent in October restarts from zero in April; a camp whose profiles stayed alive starts the season with a queue.": "Зургаа, есдүгээр сарыг урьдчилж авдаг: улирлын дундуур шинэ зургаа нийтэлж, сэтгэгдэлд тухайн долоо хоногт нь хариулж, бааз хаагдахаас өмнө дараа улирлын лавлагааг цуглуулдаг. Аравдугаар сард чимээгүй болсон бааз дөрөвдүгээр сард тэгээс эхэлдэг; профайл нь амьд байсан бааз улирлаа дараалалтай эхэлдэг.",
    "All four of these are exactly the work EPAX carries for ger camps — from less than the cost of a part-time city assistant, with an off-season pause so you pay only when you operate. The free audit shows what travelers currently see when they look for your camp; it takes 24 hours.": "Энэ дөрвөн ажил бүгд яг л EPAX-ийн гэр баазуудад зориулж үүрдэг ажил — хотын хагас цагийн туслахаас ч бага өртгөөр, улирлын завсарлагатай тул зөвхөн ажилладаг үедээ төлнө. Аялагчид таны баазыг хайхад одоо юу хардагийг үнэгүй аудит харуулна; 24 цаг л зарцуулагдана.",
    "14 Jul 2026": "2026.07.14",
    /* ---- blog: google-maps-guide ---- */
    "Getting your hotel found on Google Maps — an owner's guide": "Зочид буудлаа Google Maps дээр олддог болгох нь — эзний гарын авлага",
    "When a foreign tourist plans a night in your town, the search almost always starts in one place: Google Maps. Not your website, not a brochure — the map. If your property is missing, half-filled, or only in Mongolian, you are invisible at the exact moment a booking is decided. Here is the checklist we run for every EPAX client, written so you can do the basics yourself.": "Гадаад жуулчин таны хотод хонохоор төлөвлөхдөө хайлтаа бараг үргэлж нэг газраас эхэлдэг: Google Maps. Таны вэбсайт ч биш, танилцуулга ч биш — газрын зураг. Хэрэв таны газар тэнд байхгүй, хагас дутуу бөглөгдсөн, эсвэл зөвхөн монголоор байвал захиалга шийдэгдэх яг тэр мөчид та үл үзэгдэнэ. EPAX-ийн харилцагч бүрд ажиллуулдаг чеклистээ үндсийг нь та өөрөө хийж болохоор бичиж хүргэе.",
    "Claim it, complete it, keep one name": "Эзэмш, бүрэн бөглө, нэг нэр барь",
    "First, claim your Business Profile so you control what travelers see. Then complete every field: category, hours, phone, photos, amenities, and an English description written for travelers, not for locals. Use exactly one spelling of your business name everywhere — on Maps, on Booking.com, on Instagram, on your sign. Search engines treat every variant as a different business, and your reviews split across them.": "Эхлээд Business Profile-оо баталгаажуулж, аялагчдад юу харагдахыг өөрөө хянадаг болоорой. Дараа нь талбар бүрийг бөглөнө: ангилал, цагийн хуваарь, утас, зураг, үйлчилгээ, мөн нутгийнханд биш аялагчдад зориулж бичсэн англи тайлбар. Бизнесийнхээ нэрийг хаа сайгүй яг нэг бичлэгээр ашиглаарай — Maps, Booking.com, Instagram, хаяг самбар дээрээ. Хайлтын системүүд бичлэгийн хувилбар бүрийг өөр бизнес гэж үздэг тул сэтгэгдлүүд тань хуваагдан бутардаг.",
    "Photos decide before words do": "Үгнээс өмнө зураг шийддэг",
    "Listings with fresh, real photos get dramatically more direction requests than empty ones. Upload real rooms, real food, real mornings — and refresh them at least monthly in season. A photo from 2019 quietly tells a traveler your information cannot be trusted.": "Шинэлэг, бодит зурагтай бүртгэл хоосон бүртгэлээс хамаагүй олон зам асуулт авдаг. Бодит өрөө, бодит хоол, бодит өглөөгөө оруулаарай — улирлын үеэр дор хаяж сард нэг удаа шинэчлээрэй. 2019 оны зураг таны мэдээлэлд итгэж болохгүй гэдгийг аялагчид чимээгүй өгүүлдэг.",
    "Answer everything, in English": "Бүгдэд нь англиар хариул",
    "Reviews and questions on your listing are public conversations. A property that answers — quickly, politely, in English — reads as alive and well-run. A five-star average with silent management loses to a 4.5 with responsive management more often than owners believe.": "Бүртгэл дээрх сэтгэгдэл, асуултууд бол олон нийтэд ил яриа. Хурдан, эелдэг, англиар хариулдаг газар амьд, сайн удирдлагатай мэт уншигддаг. Дуугүй удирдлагатай 5 одтой дундаж нь хариу үйлдэлтэй удирдлагатай 4.5-д эзэд нь бодсоноос ч олон удаа ялагддаг.",
    "The details tourists actually check": "Жуулчдын үнэхээр шалгадаг жижиг зүйлс",
    "Accurate pin location (drive to it yourself and check), arrival instructions, seasonal hours, and a booking link that works on a phone. Each one of these is a place where we regularly find bookings quietly leaking away.": "Зөв байршлын зүү (өөрөө очиж шалгаарай), ирэх заавар, улирлын цагийн хуваарь, утсан дээр ажилладаг захиалгын холбоос. Эдгээрийн нэг бүрээс бид захиалга чимээгүй урсаж алдагдахыг байнга олж илрүүлдэг.",
    "Doing this well takes a few hours to set up and steady attention every week — that is the honest cost. If you would rather have it handled, platform presence is exactly what our Starter plan covers, and the free audit will show you today's gaps within 24 hours.": "Үүнийг сайн хийхэд эхэнд хэдэн цаг, дараа нь долоо хоног бүр тогтмол анхаарал шаардана — үнэн өртөг нь энэ. Харин үүнийг даалгахыг хүсвэл платформ дээрх байр суурь бол яг манай Стартер багцын ажил бөгөөд үнэгүй аудит өнөөдрийн цоорхойг тань 24 цагийн дотор харуулна.",

    /* ---- blog: hotel-occupancy-mongolia ---- */
    "Why Mongolian hotels sit at 30% occupancy — and what actually fixes it": "Монголын зочид буудлууд яагаад 30%-ийн дүүргэлттэй суудаг вэ — юу нь үнэхээр засдаг вэ",
    "Mongolia welcomed over 800,000 foreign tourists last year, yet the average hotel outside the capital runs near 30% occupancy — and even Ulaanbaatar properties leave rooms empty in peak season. After auditing dozens of properties, we can say the pattern plainly: this is rarely a product problem. The rooms are fine. It is a visibility problem, and it has a structure.": "Монгол улс өнгөрсөн жил 800,000 гаруй гадаад жуулчин хүлээн авсан ч нийслэлээс гадуурх дундаж зочид буудал 30% орчим дүүргэлттэй ажиллаж байна — Улаанбаатарын газрууд ч оргил улиралд өрөөгөө хоосон үлдээдэг. Олон арван газарт аудит хийсний эцэст бид энэ хэв маягийг шулуухан хэлж чадна: энэ нь бүтээгдэхүүний асуудал байх нь ховор. Өрөөнүүд зүгээр. Энэ бол танигдах байдлын асуудал бөгөөд тодорхой бүтэцтэй.",
    "Where the bookings leak": "Захиалга хаанаас алдагддаг вэ",
    "The leak happens in three places, in order. First, discovery: the property does not appear when travelers search in English, or appears with so little information that it gets skipped in seconds. Second, trust: outdated photos, unanswered reviews, and inconsistent names make travelers hesitate — and a hesitating traveler simply books the next option. Third, response: an inquiry sent through Maps or Instagram sits unanswered for a day, and the first competitor with a good answer wins the guest.": "Алдагдал гурван газарт, дарааллаараа гардаг. Нэгд, олдоц: аялагчид англиар хайхад газар огт гарч ирэхгүй, эсвэл хэдхэн секундэд алгасчихаар цөөн мэдээлэлтэй гарч ирдэг. Хоёрт, итгэл: хуучирсан зураг, хариугүй сэтгэгдэл, зөрсөн нэршил аялагчийг эргэлзүүлдэг — эргэлзсэн аялагч зүгээр л дараагийн сонголтыг захиалдаг. Гуравт, хариу: Maps эсвэл Instagram-аар ирсэн лавлагаа бүтэн өдөр хариугүй хэвтэж, сайн хариулттай эхний өрсөлдөгч зочныг авдаг.",
    "Why \"more marketing\" is usually the wrong prescription": "Яагаад «илүү их маркетинг» ихэвчлэн буруу жор байдаг вэ",
    "Owners often respond to empty rooms by buying ads or discounting rates. But ads pointed at a weak profile amplify the weakness — travelers click, see the gaps, and leave. And discounts attract the most price-sensitive guests while your real problem, being hard to find and slow to answer, stays untouched. Fix the funnel before you pay to fill it.": "Эзэд хоосон өрөөнд ихэвчлэн зар худалдаж авах юм уу үнээ хямдруулж хариу үзүүлдэг. Гэвч сул профайл руу чиглэсэн зар сул талыг л томруулдаг — аялагчид дарж ороод, цоорхойг хараад, гарч оддог. Хямдрал хамгийн үнэ мэдрэг зочдыг татдаг бол таны жинхэнэ асуудал — олдохгүй, удаан хариулдаг байдал — хөндөгдөлгүй үлддэг. Юүлүүрээ засаагүй байж дүүргэхийн төлөө бүү төл.",
    "What the fix actually looks like": "Засвар нь бодитоор ямар харагддаг вэ",
    "The properties we have watched climb from 30% toward 60% all did the same unglamorous things: complete English profiles on the three platforms tourists use, one consistent name everywhere, photos refreshed weekly, every review answered within a business day, and inquiries answered within hours instead of days. None of this is clever. All of it is work — steady, bilingual, every week, in season and out.": "30%-иас 60% руу өгсөхийг нь бидний харсан газрууд бүгд ижилхэн, гоц биш зүйлс хийсэн: жуулчдын хэрэглэдэг гурван платформ дээр бүрэн англи профайл, хаа сайгүй нэг нэршил, долоо хоног бүр шинэчлэгдсэн зураг, ажлын нэг өдрийн дотор хариулсан сэтгэгдэл бүр, хоногоор биш цагаар хариулсан лавлагаа. Энд ямар ч ов мэх алга. Бүгд ажил — тогтмол, хоёр хэлээр, долоо хоног бүр, улирал харгалзахгүй.",
    "That work is literally what EPAX exists to carry. If you want to know where your property leaks bookings today, the free audit maps all three failure points in 24 hours — no commitment, in English and Mongolian.": "Яг энэ ажлыг үүрэхийн тулд EPAX бий болсон. Таны газар өнөөдөр захиалгаа хаанаас алдаж байгааг мэдэхийг хүсвэл үнэгүй аудит гурван эвдрэлийн цэгийг бүгдийг 24 цагийн дотор зурж өгнө — амлалтгүй, англи монгол хэлээр.",
    /* card dates */
    "9 Jul 2026": "2026.07.09",
